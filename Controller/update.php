...
<?php 
 include "../Controller/con_conf.php";
    ...
    if($etudiant){
        ...
        <h2 class='text-center text-success'>Modifier un étudiant</h2>
        <form action='modif.php' method='POST'>
        <input type='hidden' name='id' value='$id'>
        <div class='form-group'>
        <label for='nom'>Nom</label>
        <input type='text' name='nom' id='nom' class='form-control' value='$etudiant[0]' required>
        </div>
        <div class='form-group'>
        <label for='prenom'>Prénom</label>
        <input type='text' name='prenom' id='prenom' class='form-control' value='$etudiant[1]' required>
        </div>
        <div class='form-group'>
        <label for='ddn'>Date de naissance</label>
        <input type='date' name='ddn' id='ddn' class='form-control' value='$etudiant[2]' required>
        </div>
        <div class='form-group'>
        <label for='telephone'>Email</label>
        <input type='email' name='email' id='email' class='form-control' value='$etudiant[3]' required>
        </div>
        <div class='form-group'>
        <label for='adresse'>Numero</label>
        <input type='text' name='numero' id='adresse'  class='form-control' value='$etudiant[4]' required>
        </div>
        <div class='form-group'>
